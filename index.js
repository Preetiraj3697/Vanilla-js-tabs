const content = [
  ...
  ["Hooks & state management", "Components & Props", "Life circle"]
];
...
const btnReactImp = document.getElementById("btn-react-imp");
...
btnReactImp.addEventListener("click", handleClick);
